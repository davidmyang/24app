...
public class SurvivalEndActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // // fetching score from just finished survival game mode
        int endScore = getIntent().getIntExtra("SCORE", 0);
        endScoreText.setText("Score: " + endScore);

        // retrieving user survival mode high score
        SharedPreferences prefs = this.getSharedPreferences("SURVIVAL_GAME_DATA", Context.MODE_PRIVATE);
        int highScore = prefs.getInt("SURVIVAL_HIGH_SCORE", 0);

        // checking if current score is greater than survival mode high score
        if (endScore > highScore) {
            highScoreText.setText("High Score: " + endScore);
            newHighScore.setVisibility(View.VISIBLE);
            //Save
            SharedPreferences.Editor editor = prefs.edit();
            editor.putInt("SURVIVAL_HIGH_SCORE", endScore);
            editor.commit();
        }
        else {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SurvivalEndActivity.this, MainActivity.class);
                startActivity(i);
        ...
        playAgain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SurvivalEndActivity.this, SurvivalGameActivity.class);
                startActivity(i);
                playButtonSoundEffect();
            }
        });
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SurvivalEndActivity.this, SettingsActivity.class);
                startActivity(i);
                playButtonSoundEffect();
                finish();
            }
        ...
        shoppingCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SurvivalEndActivity.this, ShoppingCartActivity.class);
                startActivity(i);
                playButtonSoundEffect();
            }
        });
