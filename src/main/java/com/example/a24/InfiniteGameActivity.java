...
public class InfiniteGameActivity extends AppCompatActivity {
    ...
    TextView fill, incorrect, correct, score, numAnswersText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infinite_game);
        ...
        // retrieving user data for infinite mode and number of solutions
        SharedPreferences prefs = this.getSharedPreferences("INFINITE_GAME_DATA", Context.MODE_PRIVATE);
        int numSolved = prefs.getInt("INFINITE_HIGH_SCORE", 0);
        score.setText(Integer.toString(numSolved));

        SharedPreferences prefs2 = this.getSharedPreferences("AD_GAME_DATA", Context.MODE_PRIVATE);
        final int[] numAnswers = {prefs2.getInt("NUM_ANSWERS", 0)};
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(InfiniteGameActivity.this)
        ...
        solutionBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (numAnswers[0] > 0 && fill.length() == 0) {
                    ...
                    numAnswers[0] = prefs2.getInt("NUM_ANSWERS", 0);
        ...
        // rules button - shows rules in popup window
    ...
    // function to count and save number of questions solved in infinite mode
    public void numQuestionsSolved() {
        SharedPreferences prefs = this.getSharedPreferences("INFINITE_GAME_DATA", Context.MODE_PRIVATE);
        int numSolved = prefs.getInt("INFINITE_HIGH_SCORE", 0);

        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("INFINITE_HIGH_SCORE", numSolved + 1);
        editor.commit();
    }
