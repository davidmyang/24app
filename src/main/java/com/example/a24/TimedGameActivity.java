...
public class TimedGameActivity extends AppCompatActivity {
    ...
    TextView fill, incorrect, correct, score, timer, numAnswersText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(TimedGameActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i = new Intent(TimedGameActivity.this, MainActivity.class);
                                startActivity(i);
    ...
    public void getDetails() {
        ...
        // creating intent
        Intent i = new Intent(TimedGameActivity.this, TimedEndActivity.class);
